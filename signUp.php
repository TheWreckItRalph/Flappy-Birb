...
<form action="/index.php" method="POST" style="text-align:center" name="signUp">
  <label for="email"><img src="Images/email.png" width="50" height="20"></label><br>
  <input type="text" id="email" name="email" style="font-size:xxpt;height:20px" onKeyup="checkform2()"><br><br>
  <label for="username"><img src="Images/username.png" width="90" height="20"></label><br>
  <input type="text" id="username" name="username" style="font-size:xxpt;height:20px" onKeyup="checkform2()"><br><br>
  <label for="password"><img src="Images/password.png" width="90" height="20"></label><br>
  <input type="password" id="password" name="password" style="font-size:xxpt;height:20px" onKeyup="checkform2()"><br> <input type="checkbox" onclick="myFunction()"><img src="Images/showpassword.png" width="100" height="20"><br><br>
  <input type="submit" name="BTN-submit" id="SignUp" value="Sign Up" disabled="disabled"><br><br>
